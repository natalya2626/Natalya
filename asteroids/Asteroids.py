...
import math
import random
from contants import (Color, Display,BULLET_SPEED, SAUCER_SPEED,
                      FD_FRIC,  PLAYER_MAX_SPEED, BD_FRIC, PLAYER_SIZE,
                      black, PLAYER_MAX_RTSPD, SMALL_SAUCER_ACCURACY 
)                      


nd_fire = pygame.mixer.Sound("Sounds/fire.wav")
...
class Game:
    def __init__(self):
        pygame.init()
        # Make surfase and dislay
        self.gameDiplay = pygame.display.set.mode(
